...
func TestParseRepository(t *testing.T) {
	tests := []struct {
		...
		{name: "valid", input: "anthr76/foo-api", wantOwner: "anthr76", wantRepo: "foo-api"},
		{name: "empty", input: "", wantErr: true},
		{name: "no slash", input: "foo-api", wantErr: true},
...
func TestLoad_EventPayload(t *testing.T) {
	...
	os.WriteFile(eventFile, []byte(eventJSON), 0o644)
